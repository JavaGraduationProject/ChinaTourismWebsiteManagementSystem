                ...
                <div class="section-dianzi" style="margin:10px 0 0 0">
                    ...
                    <div class="section_content">
                        ...
                        <div class="module-products clearfix">
                            ${jingdiangongluelist53 = Query.make("jingdiangonglue").limit(4).order("id desc").select();""}
                ...
                <div class="section-dianzi" style="margin:10px 0 0 0">
                    ...
                    <div class="section_content">
                        ...
                        <div class="blog_carousel clearfix">
                            ${jiudianlist58 = Query.make("jiudian").limit(4).order("id desc").select();""}
                ...
                <div class="section-dianzi" style="margin:10px 0 0 0">
                    ...
                    <div class="section_content">
                        ...
                        <div class="list-table">
                            ${feijipiaolist63 = Query.make("feijipiao").limit(100).order("id desc").select();""}
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="section-dianzi" style="margin:10px 0 0 0">
                    ...
                    <div class="section_content">
                        ...
                        <div class="">
                            ${xinwenxinxilist = Query.make("xinwenxinxi").limit(4).select();""}
                            <div class="news-list">
                                <ul>
